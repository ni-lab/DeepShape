...
def get_2d_data_from_patterns(patterns, transformer='l1', include_hypothetical=True, nofliprc=False):
    ...
    for pattern in patterns:
        ...
        if nofliprc:
            rev_data = np.concatenate([func(snippet[::-1]) for snippet in snippets], axis=1)
        else:
