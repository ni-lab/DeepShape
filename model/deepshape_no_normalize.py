...
"""
DeepShape with min-max normalization removed. The purpose of removing
min-max normalization is for cleaner DeepLIFT attributions, as DeepLIFT
does not support this nonlinearity. A model trained with normalization
can be loaded and used without normalization using this class. In that
case, normalization of shape features should be done at encoding time,
using the GenomeShape class from genomeshape_normalize.py.
"""
