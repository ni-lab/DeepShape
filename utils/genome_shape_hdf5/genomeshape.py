...
def load_from_file(shape_feature_file):
	if 'hdf5' in shape_feature_file:
		...
		return ShapeFasta(shape_feature_file)


class GenomeShape(Genome):
	def __init__(self, input_path, shape_feature_files=None, blacklist_regions=None, bases_order=None,
	             init_unpicklable=False,
	             multi_feat_file=None):
		"""
	...
	def get_shape_features_from_coords(self, chrom, start, end, strand='+', pad=False):
		if self.multi_feat_file:
			...
			return self.shape_features[chrom][start:end]
		shape_features = []
	...
	def get_encoding_from_coords(self, chrom, start, end, strand='+', pad=False):
		...
		#	print("Shape of shape features:", shape_features.shape)
		# else:
		#	print("No shape features available.")
		# print("chrom:", chrom)
		# print("start:", start)
		# print("end:", end)
		# /debug
