"""
This module provides the `ParallelIntervalsSampler` class and supporting
methods.
"""
...
def init(l, h_n_s, n_s, n_c, s, t, self_):
...
class ParallelIntervalsSampler(OnlineSampler):
    ...
    def sample(self, batch_size=1, mode=None):
        ...
        enc_len = 4 + len(self.reference_sequence.shape_features)
        ...
        initargs = (lock, hyp_n_samples_drawn, n_samples_drawn, n_cache_accesses, sequences, targets, self)
        n_procs = 8
